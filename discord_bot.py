import discord, os, random, crawling, aiocron, const, asyncio
...
async def main():
    bot = commands.Bot(command_prefix=const.PREFIX, status=discord.Status.online, activity=game, intents=intents)
